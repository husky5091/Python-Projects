from math import sqrt, sin, cos, tan, radians, degrees, log, log10, log2, ceil, pow
...
def addition():
    try:
        ...
        print('PyMaths has detected an error:', error)
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            checkos()
            quit()
...
def calculatesin():
    try:
        ...
        print('Result in radians: sin (', angle ,')', '=', sinresultradians)
        print('Result in degrees: sin (', angle, ')', '=', sinresultdegrees)
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            checkos()
            quit()
...
def calculatecos():
    try:
        ...
        print('Result in radians: cos (', angle ,')', '=', cosresultradians)
        print('Result in degrees: cos (', angle, ')', '=', cosresultdegrees)
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            checkos()
            quit()
...
def calculatetan():
    try:
        ...
        print('Result in radians: tan (', angle ,')', '=', tanresultradians)
        print('Result in degrees: tan (', angle, ')', '=', tanresultdegrees)
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            checkos()
            quit()
