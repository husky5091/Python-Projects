...
def degreestoradians():
    try:
        ...
        print('Result:', degrees23, 'degrees converted into radians is:', radians(degrees23), '!')
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            quit()
    except Exception as error:
...
def radianstodegrees():
    try:
        ...
        print('Result:', radians23, 'radians converted into degrees is:', degrees(radians23), '!')
        runagain = input("Would you like to run PyMaths again ? (Y/N): ")
        if(runagain == 'N' or runagain == 'n'):
            checkos()
            quit()
